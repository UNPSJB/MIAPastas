...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('ver_productos_terminados_disponibles', 'Puede listar los productos disponibles'), ('ver_perdida_stock', 'Puede listar la cantidad productos perdidos'), ('ver_productos_mas_vendidos', 'Puede listar los productos mas vendidos')),
            },
        ),
        migrations.CreateModel(
            name='Proveedor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('pedidocliente_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='recetas.PedidoCliente')),
                ('fecha_inicio', models.DateField(default=datetime.date(2015, 11, 25))),
                ('fecha_cancelacion', models.DateField(null=True, blank=True)),
